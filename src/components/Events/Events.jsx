          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                <h1 className="text-4xl text-center sm:text-4xl font-bold font-cursive">
                  Our First Smile
                </h1>
                <p className="text-xl text-center text-gray-900 tracking-wide leading-5 font-corben">
                  A unique experience that celebrates the joy and beauty of
                  love, helping couples reminisce about thier first special
                  moments together
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="border-l-4 border-primary/50 pl-5 space-y-2 text-left mr-4">
                    <h1 className="text-2xl font-semibold font-cursive">
                      Registration
                    </h1>
                    <p className="text-sm text-gray-500">
                      Promises to be an event you will never forget. And we
                      can&apos;t wait to have you register below!👇
                    </p>
