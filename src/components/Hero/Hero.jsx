  ...
  return (
    ...
    >
      <div className="text-center px-4 sm:px-8 lg:px-16">
        ...
        >
          &quot;An intimate experience designed for couples to reconnect, have
          fun, and celebrate love in a distraction-free environment. It provides
          a space where partners can deepen their bond, rediscover each other,
